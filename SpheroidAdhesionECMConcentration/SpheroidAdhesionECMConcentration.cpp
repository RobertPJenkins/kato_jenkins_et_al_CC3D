...
#include "SpheroidAdhesionECMConcentration.h"
...
SpheroidAdhesionECMConcentration::SpheroidAdhesionECMConcentration() :  cellFieldG(0),sim(0),potts(0) {}

SpheroidAdhesionECMConcentration::~SpheroidAdhesionECMConcentration() {
}



void SpheroidAdhesionECMConcentration::init(Simulator *simulator, CC3DXMLElement *_xmlData) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void SpheroidAdhesionECMConcentration::extraInit(Simulator *simulator){

}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

void SpheroidAdhesionECMConcentration::start(){
...
void SpheroidAdhesionECMConcentration::step(const unsigned int currentStep){
	...
	for(cInvItr=cellInventoryPtr->cellInventoryBegin() ; cInvItr !=cellInventoryPtr->cellInventoryEnd() ;++cInvItr ){
		...
		for(set<BoundaryPixelTrackerData>::iterator sitr=cellBoundaryPixels.begin() ; sitr != cellBoundaryPixels.end() ;++sitr){
			...
			for(int i=-1;i<2;i++){
				for(int j=-1;j<2;j++){
					for(int k=-1;k<2;k++){
						int currx=xx+i;int curry=yy+j; int currz=zz+k;
						if(currx>=0 && currx<dimx && curry>=0 && curry<dimy && currz>=0 && currz<dimz){
...
void SpheroidAdhesionECMConcentration::finish(){	
}

void SpheroidAdhesionECMConcentration::update(CC3DXMLElement *_xmlData, bool _fullInitFlag){
...
std::string SpheroidAdhesionECMConcentration::toString(){
   return "SpheroidAdhesionECMConcentration";
}


std::string SpheroidAdhesionECMConcentration::steerableName(){
   return toString();
}
