...
#ifndef SPHEROIDADHESIONECMCONCENTRATIONSTEPPABLE_H
#define SPHEROIDADHESIONECMCONCENTRATIONSTEPPABLE_H
...
#include <iostream>
#include <fstream>
#include "SpheroidAdhesionECMConcentrationDLLSpecifier.h"
...
namespace CompuCell3D {
  ...
  class SPHEROIDADHESIONECMCONCENTRATION_EXPORT SpheroidAdhesionECMConcentration : public Steppable {
    ...
    int dimx,dimy,dimz;
    float SCCECMMinAdh, VCAFECMMinAdh;
    float RecipPower;
    float quadraticA, quadraticB, quadraticContact;
    float MinAdh, MaxAdh;
  ...
  public:
    SpheroidAdhesionECMConcentration();

    virtual ~SpheroidAdhesionECMConcentration();
    // SimObject interface
