...
#ifndef SPHEROIDECMCONCENTRATIONUPDATESTEPPABLE_H
#define SPHEROIDECMCONCENTRATIONUPDATESTEPPABLE_H
...
#include "SpheroidECMConcentrationUpdateDLLSpecifier.h"
...
namespace CompuCell3D {
  ...
  class SPHEROIDECMCONCENTRATIONUPDATE_EXPORT SpheroidECMConcentrationUpdate : public Steppable {
  ...
  public:
    SpheroidECMConcentrationUpdate();

    virtual ~SpheroidECMConcentrationUpdate();
    // SimObject interface
