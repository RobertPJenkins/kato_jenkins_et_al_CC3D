...
#ifndef ORGANOTYPICCELLBOUNDARYECMPENETRATIONSTEPPABLE_H
#define ORGANOTYPICCELLBOUNDARYECMPENETRATIONSTEPPABLE_H
...
#include "OrganotypicCellBoundaryECMPenetrationDLLSpecifier.h"
...
namespace CompuCell3D {
  ...
  class ORGANOTYPICCELLBOUNDARYECMPENETRATION_EXPORT OrganotypicCellBoundaryECMPenetration : public Steppable {
  ...
  public:
    OrganotypicCellBoundaryECMPenetration();

    virtual ~OrganotypicCellBoundaryECMPenetration();
    // SimObject interface
