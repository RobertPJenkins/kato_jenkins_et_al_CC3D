...
#ifndef SPHEROIDCELLBOUNDARYECMPENETRATIONSTEPPABLE_H
#define SPHEROIDCELLBOUNDARYECMPENETRATIONSTEPPABLE_H
...
#include "SpheroidCellBoundaryECMPenetrationDLLSpecifier.h"
...
namespace CompuCell3D {
  ...
  class SPHEROIDCELLBOUNDARYECMPENETRATION_EXPORT SpheroidCellBoundaryECMPenetration : public Steppable {
  ...
  public:
    SpheroidCellBoundaryECMPenetration();

    virtual ~SpheroidCellBoundaryECMPenetration();
    // SimObject interface
